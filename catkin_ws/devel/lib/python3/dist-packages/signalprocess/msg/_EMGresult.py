...
"""autogenerated by genpy from signalprocess/EMGresult.msg. Do not edit."""
import codecs
import sys
...
class EMGresult(genpy.Message):
  _md5sum = "420cd38b6b071cd49f2970c3e2cee511"
  _type = "signalprocess/EMGresult"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EMGresult, self).__init__(*args, **kwds)
